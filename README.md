...
![noname03](https://user-images.githubusercontent.com/51878026/183587646-e5e59347-5582-4b8a-83cb-2362da071d8f.png)  
[그림 3] 수면 무호흡증의 위험성
...
[그림 17] 바람센서 구매 내역  
* 아두이노를 조립하여 작동시키기 위해 필요한 필수적인 부품들인 [그림 17]의 부품들을 구매하였다.
...
[그림 28] 소리센서 아두이노 코드
* [그림 27]은 소리센서(빨간색 부품) 를 착용시킨 아두이노의 모습이다.
* 소리센서를 작동한 결과 [그림 28]과 같이 나왔다. 박수를 치거나 콧바람을 센서에 닿게 하면 크기가 높게 측정되었다.
* 소리센서 코드는 [그림 29]와 같다.
...
[그림 31] 수정된 아두이노 코드  
* [그림 31]은 어느정도 이상의 소리센서 값이 감지되면, 호흡을 하고있고, 그 미만이 감지되면 수면 무호흡증이라고 판단을 하도록 하는 아두이노 코드이다.
* [그림 31]에서 value가 호흡 임계값이다. 41로 설정해두었고, [그림 30]을 보면 1초동안 41 이상의 값이 감지되지 않아서 “hm10.println("AT+MINO0x0001")” 가 출력되고 있다.
